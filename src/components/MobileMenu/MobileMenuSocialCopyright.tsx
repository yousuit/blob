...
class MobileMenuSocialCopyright  extends React.Component<Props & WrappedComponentProps> {
	render() {
		...
		return (
			<div className={`${styles.socialCopyright} ${this.props.connectModule ? 'connectModule' : null}`}>
				...
				<div className={styles.copyrightLanguage}>
					<span className={styles.copyrightMessage}>
                        <SelectLanguage
                            isSearch={true}
                            inMenu={true}
...
export default injectIntl(MobileMenuSocialCopyright);