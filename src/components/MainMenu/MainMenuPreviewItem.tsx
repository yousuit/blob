                        ...
                        <>
                            <div className={stylesPreview.wrapper}>
                                <div className={stylesPreview.wrapperContent}>
                                    <div className={stylesPreview.contentWrapper}>
                                        {this.currData.heroImage && (
                                            <GatsbyImageWrapper
                                                image={{
                                                    ...
                                                    sources: [
                                                        {
                                                        srcSet: `${this.currData.heroImage.file.url}?w=672&fit=fill&fm=webp 800w`,
                                                        type: "image/webp",
                                                        },
                                                    ],
                                                    },
                                                ...
                                                outerWrapperClassName={stylesPreview.previewImage}
                                    ...
                                    <div className={stylesPreview.listWrapper}>
                                        {
                                        // @ts-ignore
                                            ...
                                            <GatsbyImageWrapper
                                                image={{
                                                    ...
                                                    sources: [
                                                        {
                                                        // @ts-ignore
                                                        srcSet: `${this.currData.entityLogo.file.url}?w=326&fit=pad&&bg=rgb:ffffff&fm=webp 800w`,
                                                        type: "image/webp",
                                                        },
                                                    ],
                                                    },
                                                ...
                                                alt={this.currData.title}
                                                outerWrapperClassName={styles.logo}
                                            />
                                        )}
                                        <TopSectionListInfo className={stylesPreview.listInfo}>
                                            ...
                                            {this.currData.email && (
                                                <TopSectionListItem isMainMenu={true} label={<FormattedMessage id={'E-mail'} />} value={<a href={'mailto:' + this.currData.email}>{this.currData.email}</a>} />
                                            )}
                                            ...
                                            {this.currData.openingHours && <TopSectionListItem isMainMenu={true} label={<FormattedMessage id={'opening_hours'} />} value={this.currData.openingHours.openingHours} />}
                                            ...
                                            {this.currData.filterProgramType && <TopSectionListItem isMainMenu={true} label={<FormattedMessage id={'Type'} />} value={this.currData.filterProgramType.title} />}
